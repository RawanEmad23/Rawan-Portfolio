...
export default function ProjectsPage() {
  return (
   <section
  id="projects"
  className="min-h-screen bg-gradient-to-r from-pink-100 via-purple-100 to-pink-200 
          ...
          <div className="p-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                className="px-6 py-3 bg-pink-400 text-white font-semibold rounded-full shadow-md 
